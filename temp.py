...
for r in range(0, 255):
    for g in range(0, 255):
        texture_data.append(r / 255)
        texture_data.append(g / 255)
        texture_data.append(r / 255)
        texture_data.append(g / 255)
...
with dpg.texture_registry(show=True):
    dpg.add_raw_texture(width=255, height=255, default_value=raw_data, format=dpg.mvFormat_Float_rgba, tag="texture_tag")
